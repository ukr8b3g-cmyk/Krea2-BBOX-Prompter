...
EFFECT_CATEGORIES = ('All', 'Photo', 'Camera FX', 'Art', 'Light', 'Mood', 'Color Theme', 'Finish', 'Deco', 'Custom', 'Custom Preset', 'Photo Look', 'Base Style', 'Portrait', 'Cinematic', 'Illustration', 'Lighting', 'Commercial')
EFFECT_PRESETS = (
    'None',
    'Custom Preset',
    'Realistic Photo',
...
EFFECT_PRESET_TEXT = {
    ...
    'Thermal Camera': 'thermal camera image, false-color heatmap palette, glowing warm subjects, cool dark background, infrared temperature-vision look',
    ...
    'Kawaii Deco': 'kawaii decoration style, cute pastel accents, hearts, stars, sparkles, soft playful atmosphere',
    'Sweet Deco': 'sweet cute decoration, soft pink hearts, candy-like colors, gentle sparkles, romantic playful atmosphere',
    'Pop Cute Deco': 'pop cute decoration, bright colorful stickers, playful doodles, stars, sparkles, cheerful energetic atmosphere',
    'Heart Deco': 'cute heart decorations, scattered hearts, playful romantic accents, soft pop atmosphere',
    'Sparkle Deco': 'sparkle decorations, glittering stars, shiny highlights, magical twinkle accents',
    'Doodle Deco': 'playful doodle decorations, hand-drawn lines, cute scribbles, casual marker accents',
    'Sticker Deco': 'sticker-like decorations, cute sticker accents, playful pop graphics, layered decorative elements',
    'Pop Deco': 'pop decoration style, bright playful accents, colorful graphic motifs, fun energetic atmosphere',
    'Frame Deco': 'decorative frame accents, playful border decoration, cute graphic frame around the image',
    'Glitter Deco': 'glitter decoration, sparkling particles, shiny festive accents, glossy decorative highlights',
    'Star Deco': 'star decorations, scattered stars, bright twinkle accents, cute dreamy atmosphere',
    'Ribbon Deco': 'ribbon decorations, cute ribbon accents, soft decorative details, playful feminine style',
    'Bubble Deco': 'bubble decorations, floating bubbles, glossy round accents, playful light atmosphere',
    'Stamp Deco': 'stamp-like decorations, playful graphic stamps, cute printed accents, casual photo booth style',
    'Graffiti Deco': 'graffiti-style decorations, bold marker lines, playful scribbles, energetic street-style accents',
    'Neon Deco': 'neon decorations, glowing outlines, bright neon accents, playful night-pop atmosphere',
    'Dreamy Deco': 'dreamy decorations, soft sparkles, floating hearts, gentle glow, cute fantasy atmosphere',
    'Paper Print': 'printed on paper, subtle paper grain, matte texture, soft ink absorption, tactile print finish',
    'Matte Print': 'matte print finish, non-reflective surface, soft contrast, smooth paper texture',
    'Glossy Print': 'glossy print finish, reflective coating, crisp contrast, polished photo paper surface',
    'Canvas Texture': 'canvas texture, woven fabric surface, subtle textile grain, painterly material finish',
    'Fabric Print': 'printed on fabric, soft cloth texture, woven fibers, gentle ink diffusion, textile surface finish',
    'Metal Print': 'printed on metal, glossy metallic surface, reflective highlights, sleek hard material finish',
    'Glass Print': 'behind glass, glossy glass surface, subtle reflections, polished transparent finish',
    'Wet Surface': 'wet surface effect, water droplets, glossy highlights, damp reflective texture, fresh moisture finish',
    'Water Droplets': 'water droplets on surface, clear beads of moisture, glossy highlights, fresh wet finish',
    'Dusty Surface': 'dusty surface effect, fine dust particles, muted texture, aged dry finish, subtle grime',
    'Scratched Print': 'scratched print surface, fine scratches, worn texture, distressed physical finish',
    'Vintage Paper': 'vintage paper texture, aged paper grain, faded ink, warm yellowed surface, old printed finish',
    'Stone Surface': 'stone surface texture, rough mineral grain, cool hard material finish, natural stone detail',
    'Marble Finish': 'marble surface finish, subtle veining, polished stone texture, elegant mineral material',
    'Concrete Finish': 'concrete surface texture, rough gray material, fine grain, industrial matte finish',
    'Rusty Metal': 'rusty metal surface, oxidized texture, reddish brown corrosion, worn industrial finish',
    'Aged Metal': 'aged metal finish, tarnished surface, subtle scratches, oxidized patina, weathered material',
    'Patina Finish': 'patina surface finish, green-blue oxidized metal, aged copper look, weathered decorative texture',
    'Wood Grain': 'wood grain texture, natural wooden surface, warm organic material finish, visible grain lines',
    'Leather Finish': 'leather surface texture, subtle grain, soft worn material, tactile premium finish',
    'Ceramic Glaze': 'ceramic glazed surface, smooth glossy coating, subtle reflections, crafted material finish',
    'Plastic Finish': 'plastic surface finish, smooth synthetic texture, clean highlights, modern manufactured material',
    'Slime Finish': 'slime surface finish, glossy translucent gel texture, sticky wet highlights, soft gooey material look',
    'Gel Finish': 'gel surface finish, translucent glossy material, smooth jelly-like highlights, soft elastic texture',
    'Liquid Gloss': 'liquid glossy finish, wet reflective coating, smooth flowing highlights, polished fluid surface',
    'Gummy Finish': 'gummy material finish, soft translucent candy texture, rounded glossy surface, playful elastic look',
    'Wax Finish': 'wax surface finish, soft semi-gloss texture, smooth melted material, subtle warm highlights',
    ...
    'Crazy Color': 'crazy color theme, playful clashing palette, unexpected color combinations, energetic stylized color grading',
    'Candy Color': 'candy color theme, sweet bright palette, playful pastel-neon colors, cheerful glossy atmosphere',
    'Pop Color': 'pop color theme, bold graphic palette, bright saturated colors, fun energetic visual style',
    'Dreamy Color': 'dreamy color theme, soft luminous palette, gentle haze, ethereal pastel color grading',
    'Acid Color': 'acid color theme, intense fluorescent palette, surreal high-energy color grading, experimental atmosphere',
    'Cyber Color': 'cyber color theme, neon cyan and magenta palette, dark futuristic contrast, digital glow atmosphere',
    'Rainbow Color': 'rainbow color theme, full-spectrum colorful palette, joyful multicolor grading, vibrant playful atmosphere',
    'Holographic Color': 'holographic color theme, iridescent pastel palette, shifting rainbow highlights, glossy futuristic color grading',
    'Vaporwave Color': 'vaporwave color theme, pink cyan purple palette, retro digital color grading, nostalgic surreal atmosphere',
    'Fantasy Color': 'fantasy color theme, magical saturated palette, glowing imaginative color grading, whimsical atmosphere',
