...
EFFECT_CATEGORIES = ('All', 'Photo', 'Camera FX', 'Art', 'Light', 'Mood', 'Color Theme', 'Custom', 'Custom Preset', 'Photo Look', 'Base Style', 'Portrait', 'Cinematic', 'Illustration', 'Lighting', 'Commercial')
EFFECT_PRESETS = (
    'None',
    'Custom Preset',
    'Realistic Photo',
