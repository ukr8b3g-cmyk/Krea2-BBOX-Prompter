...
EFFECT_PRESET_TEXT = {
    ...
    'Flash Photo': 'nighttime photography, dark environment, on-camera flash, dramatic shadows, illuminated foreground, deep blacks, grainy high ISO texture, unexpected direct light, photographic snapshot realism',
    'Direct Flash': 'direct flash photo, harsh frontal light, strong shadows, crisp subject detail, bright specular highlights, dark background, sharp focus, edgy photographic camera look',
    'Disposable Flash': 'disposable camera flash photo, harsh frontal flash, casual snapshot framing, grainy film texture, illuminated foreground, deep shadows, nostalgic point-and-shoot realism',
    'Paparazzi Flash': 'paparazzi flash photography, strong repeated camera flash, bright foreground subject, deep dark background, high contrast, candid celebrity-style night snapshot, photographic realism',
    'Red Eye Flash': 'red-eye flash photo effect, on-camera flash causing visible red pupils, direct frontal flash, dark environment, snapshot realism, strong catchlight, photographic camera artifact',
    'Red Eye Flash': 'red-eye flash photo effect, on-camera flash causing visible red pupils, direct frontal flash, dark environment, snapshot realism, strong catchlight, photographic camera artifact',
