...
Prompt textarea
Type: Object / Text
Framing: Auto / Full body / Upper body / Bust-up / Headshot / Close-up / Lower body / Full object / Detail shot / Macro detail
Prompt preset
Save / Load / Delete
```
...
## 7. Add Effects with Prompt Effect
...
- `prompt_ui_data` stores scene/background text and per-slot prompt/type/framing data.
...
- Framing options append helper phrases such as upper-body, bust-up, headshot, detail shot, and macro detail.
...
## 7. Prompt Effectで効果を追加する（ON / OFF）
